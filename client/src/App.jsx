...
import MyPageUserPosts from './pages/MyPageUserPosts';
        ...
        <Router>
          <Routes>
            ...
            <Route path='Market'>
              ...
              <Route path=':id' element={<MarketDetail socket={socket} />} />
              <Route path='search' element={<MarketSearchResult />} />
            </Route>
            ...
            <Route path='/MyPage/userPosts' element={<MyPageUserPosts />} />
