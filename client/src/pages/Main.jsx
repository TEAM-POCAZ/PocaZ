        ...
        <div className='mainContentsWrap'>
            ...
            >
              <SwiperSlide className='relative'>
                <img
                  ...
                  alt='메인 배너 01'
                />
                <div className='slideTxt cursor-default absolute top-[60%] left-0 ml-3.5 text-white font-bold text-[24px] tracking-tighter'>
                  <h3>포~카즈! 런칭 기념</h3>
          ...
          <div className='px-3.5 mt-7 bg-white'>
            <div className='boardWrap mb-6'>
              <button
                className='flex mb-3.5 text-2xl font-extrabold'
            ...
            <div className='bestPoca mb-6'>
              <div className='subject mb-3.5'>
                ...
                <h4 className='text-gray-500 text-sm cursor-default'>
            ...
            <div className='boardBoast mb-6'>
              <div className='subject mb-3.5'>
                <button
                  className='text-2xl font-extrabold'
                  onClick={() => navigate('/CommunityBoast')}
                >
                  포꾸 자랑
                </button>
                <h4 className='text-gray-500 text-sm cursor-default'>
